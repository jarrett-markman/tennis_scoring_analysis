...
viz4 <- ggplot(m_diff_df, aes(x = condition, y = difference, fill = condition)) +
  geom_boxplot() +
  labs(x = "Scoring System", y = "Difference (Expected - Actual Win Percentage)",
       title = "Distribution of Differences between Expected and Actual Win Percentages in Men's Matches",
       subtitle = "Expected win percentage is the win rate in a 100 simulated grand slam matches",
       caption = "Jarrett Markman") +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        ...
        legend.position = "none")
# Viz 5 - Density Plot
viz5 <- ggplot(m_diff_df, aes(x = difference, fill = condition)) +
  geom_density(alpha = 0.75) +
  labs(
    title = "Density Plot of Differences by Scoring System in Men's Matches",
    x = "",
    y = "Density",
    fill = "Condition",
    caption = "Jarrett Markman"
...
viz6 <- m_var_data %>%
  ...
  labs(
    ...
    subtitle = "Variance is measured as the difference between player expected win probability over 100 grand slam simulations and individual simulations",
    caption = "Jarrett Markman"
  ) +
  theme_bw() +
  theme(
...
# Viz 7 - Boxplot
viz7 <- ggplot(w_diff_df, aes(x = condition, y = difference, fill = condition)) +
  geom_boxplot() +
  labs(x = "Scoring System", y = "Difference (Expected - Actual Win Percentage)",
       title = "Distribution of Differences between Expected and Actual Win Percentages in Women's Matches",
       subtitle = "Expected win percentage is the win rate in a 100 simulated grand slam matches",
       caption = "Jarrett Markman") +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        ...
        legend.position = "none")
# Viz 8 - Density Plot
viz8 <- ggplot(w_diff_df, aes(x = difference, fill = condition)) +
  geom_density(alpha = 0.75) +
  labs(
    title = "Density Plot of Differences by Scoring System in Women's Matches",
    x = "",
    y = "Density",
    fill = "Condition",
    caption = "Jarrett Markman"
